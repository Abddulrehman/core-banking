...
@ApplicationScoped
@Unremovable
@Named("karachimain-credential-provider")
public class KarachiMainCredentialsProvider implements CredentialsProvider {

    @Inject
    @DataSource("karachi-main-app")
    ...
    public Map<String, String> getCredentials(String credentialsProviderName) {
        String username = "";
        String password = "";
        try (Connection connection = karachiMainDatasource.getConnection();
