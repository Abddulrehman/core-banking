...
@ApplicationScoped
@Unremovable
@Named("obs-credential-provider")
public class ObsCredentialsProvider implements CredentialsProvider {
    ...
    public Map<String, String> getCredentials(String credentialsProviderName) {
        ...
        try (Connection connection = obsDataSource.getConnection();
                PreparedStatement preparedStatement = connection
                        .prepareStatement("SELECT * FROM APPUSER.OBS_CONNECTION_TL ct2 ");
